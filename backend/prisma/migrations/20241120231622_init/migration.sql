...
*/
-- CreateEnum
CREATE TYPE "Natureza" AS ENUM ('Normal', 'Fogo', 'Agua', 'Planta', 'Eletrico', 'Psiquico', 'Gelo', 'Lutador', 'Venenoso', 'Terrestre', 'Voador', 'Inseto', 'Pedra', 'Fantasma', 'Dragao', 'Noturno', 'Aco', 'Fada');

-- AlterTable
ALTER TABLE "Pokemon" DROP COLUMN "tipo",
ADD COLUMN     "tipo" "Natureza" NOT NULL;
